{{--
    Gaya dokumen cetak, dipakai bersama oleh layouts/print (layar & printer)
    dan layouts/pdf (unduhan PDF lewat dompdf).

    Dipisah supaya keduanya tidak pernah berbeda rupa. dompdf tidak mengenal
    flexbox, jadi layouts/pdf menimpa beberapa aturan di sini dengan padanan
    berbasis tabel - itu satu-satunya perbedaan yang disengaja.
--}}
        /*
        ...
        /* Lebar kolomnya sengaja dibiarkan otomatis, bukan dibagi rata:
           .doc-type memakai white-space:nowrap, jadi kolom kanan mengambil
           persis selebar jenis dokumennya dan sisanya untuk identitas. */
        .letterhead {
            width: 100%;
        ...
        .letterhead > tbody > tr > td {
            vertical-align: top;
        }

        .letterhead > tbody > tr > td:last-child {
            text-align: right;
            padding-left: 8mm;
        }

        /* Logo berdampingan dengan nama perusahaan, bukan di atasnya. */
        .letterhead-brand {
            border-collapse: collapse;
        }

        .letterhead-brand > tbody > tr > td {
            vertical-align: top;
        }
        ...
        /*
         * Bidang berdampingan memakai tabel, bukan flexbox.
         *
         * Dokumen yang sama juga dirender dompdf untuk unduhan PDF, dan dompdf
         * mengabaikan display:flex tanpa peringatan — kolomnya menumpuk ke
         * bawah, dan itu baru ketahuan setelah berkasnya dibuka. Tabel dirender
         * sama persis oleh peramban maupun dompdf.
         *
         * table-layout:fixed yang membagi lebarnya rata, menggantikan flex:1.
         */
        .party {
            width: 100%;
            table-layout: fixed;
        ...
        /* Tabel tidak mengenal gap; jaraknya dari padding sisi dalam. */
        .party > tbody > tr > td:first-child {
            padding-right: 4mm;
        }

        .party > tbody > tr > td:last-child {
            padding-left: 4mm;
        }
        ...
        .closing > tbody > tr > td:first-child {
            padding-right: 4mm;
        }

        .closing > tbody > tr > td:last-child {
            padding-left: 4mm;
        }

        /* Satu kolom per tanda tangan, lebarnya dibagi rata berapa pun
           jumlahnya — dua pada penawaran, tiga pada surat jalan. */
        .signatures {
            width: 100%;
            table-layout: fixed;
            border-collapse: collapse;
