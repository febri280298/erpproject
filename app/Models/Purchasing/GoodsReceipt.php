...
class GoodsReceipt extends Model
{
    ...
    protected $fillable = [
        'grn_no', 'date', 'purchase_order_id', 'partner_id', 'warehouse_id',
        'supplier_do_no', 'status', 'notes', 'created_by', 'posted_at',
    ];
    ...
    {
        return round((float) $this->items->sum(fn (GoodsReceiptItem $i) => (float) $i->quantity * (float) $i->unit_price), 2);
    }
